...
namespace eTrade.DataAccess.Migrations
{
    ...
    [Migration("20230425184531_init11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.AppRole", b =>
                {
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.InvoiceFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.Endpoint", null)
                        .WithMany()
                        .HasForeignKey("EndpointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eTrade.Entities.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Basket", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.BasketItem", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.Basket", "Basket")
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.CompletedOrder", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.Order", "Order")
                        .WithOne("CompletedOrder")
                        .HasForeignKey("eTrade.Entities.Concrete.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Endpoint", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("eTrade.Entities.Concrete.Order", b =>
                {
                    ...
                    b.HasOne("eTrade.Entities.Concrete.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("eTrade.Entities.Concrete.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eTrade.Entities.Concrete.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
