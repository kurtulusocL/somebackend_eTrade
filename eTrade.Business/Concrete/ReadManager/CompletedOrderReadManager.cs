...
{
    public class CompletedOrderReadManager : EntityReadRepositoryBase<CompletedOrder>, ICompletedOrderReadService
    {
        public CompletedOrderReadManager(ApplicationDbContext context) : base(context)
        {
        }
    }
}
